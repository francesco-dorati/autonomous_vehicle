...
from raspberry_pi.network.map_transmitter import MapTransmitter
    ...
    while True:
        if connection == None:
            ...
            try:
                ...
                robot.start()
                MapTransmitter.start(HOST, DISPLAY_PORT, robot)
