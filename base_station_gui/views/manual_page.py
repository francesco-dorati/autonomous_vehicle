...
class ManualPage(tk.Frame):
    def __init__(self, parent):
        ...
        self.control_frame = tk.Frame(self, borderwidth=3)
        self.camera_frame = CameraFrame(self.control_frame)
        self.data_frame = DataFrame(self.control_frame)
        self.exit_button = tk.Button(self, text="Exit Manual Controller", font=("Arial", 16))
        
        self.label.pack(pady=15)    
        self.control_frame.pack(pady=10, padx=15, expand=True, fill='both')
        self.camera_frame.pack(side='left', fill='both', expand=True, padx=7)
        self.data_frame.pack(side='left', fill='y', padx=7)
...
class CameraFrame(tk.Frame):
    def __init__(self, parent):
        ...
        self.button = tk.Button(self, text="Start Camera", font=("Arial", 16))
        self.button.pack(fill='none', pady=20, expand=True)

class DataFrame(tk.Frame):
    def __init__(self, parent):
        super().__init__(parent)
        self.config(borderwidth=2, relief='solid', width=200)
        ...
        self.control_label = tk.Label(self.control_frame, text="Controls: ", font=("Arial", 18))
        self.keys_frame = tk.Frame(self.control_frame)
        ...
        # PACK CONTROLS
        self.control_frame.pack(fill='x', side='top', pady=10)
